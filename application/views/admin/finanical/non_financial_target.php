...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Non-Finanical Target</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Non-Financial</li>
        </ol>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function generateReport(year){
    $.blockUI
        ...
        $("#mainContentdiv").load('<?php echo base_url();?>index.php?adminController/financialtarget/finanical/Companytarget/'+year);
