        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Customer Disconnected</span>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <p class="text-center">
                      <strong>Sales: 1 Jan, 2020 - 30 Feb, 2020</strong>
                    </p>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="progress-group">
                      Revenue
                      <span class="float-right"><b>Nu 4000 Million</b>/4500 Million</span>
                   ...
                   <div class="progress-group">
                      Sales of Vivo Phone
                      <span class="float-right"><b>750</b>/10000</span>
                      <div class="progress progress-sm">
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">Nu 35,210.43</h5>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">Nu 10,390.90</h5>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">Nu 24,813.53</h5>
