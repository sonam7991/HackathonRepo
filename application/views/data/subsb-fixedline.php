...
<section class="content">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">Import Data for Fixed-Line Subscriber</h3>
    </div>
    <div class="box-body">
      <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label>Fixed-Line Scriber :<span class="text-danger">*</span></label>
                  ...
                  <div class="form-group">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <button class="btn btn-success pull-right" type="button" onclick="updatefl()"> <i class="fa fa-plus"></i>Upload</button>
                      </div>
                  </div>
                </div>
            </div>
